...
function Footer() {
  return (
    <>
      ...
      <footer>
        <div class="container-fluid py-3 py-md-6 py-xl-9 py-xxl-10" style={{ backgroundColor: '#ECEFF1' }}>
                ...
                <div class="row gy-4 gy-md-0">
                  <div class="col-6 col-md-3">
                    <div class="link-wrapper">
                      <h4 class="mb-3 fs-6 text-dark">Clients</h4>
                      <ul class="m-0 list-unstyled">
                        <li class="mb-1">
                          <a href="#!" class="link-opacity-75 link-underline-opacity-0 link-opacity-100-hover link-underline-opacity-100-hover link-offset-1 link-dark">
                            Templates
                          </a>
                        </li>
                        <li class="mb-1">
                  ...
                  <div class="col-6 col-md-3">
                    <div class="link-wrapper">
                      <h4 class="mb-3 fs-6 text-dark">Talent</h4>
                      <ul class="m-0 list-unstyled">
                        <li class="mb-1">
                          <a href="#!" class="link-opacity-75 link-underline-opacity-0 link-opacity-100-hover link-underline-opacity-100-hover link-offset-1 link-dark">
                            Operations
                  ...
                  <div class="col-6 col-md-3">
                    <div class="link-wrapper">
                      <h4 class="mb-3 fs-6 text-dark">Resources</h4>
                      <ul class="m-0 list-unstyled">
                        <li class="mb-1">
                          <a href="#!" class="link-opacity-75 link-underline-opacity-0 link-opacity-100-hover link-underline-opacity-100-hover link-offset-1 link-dark">
                            Community
                  ...
                  <div class="col-6 col-md-3">
                    <div class="link-wrapper">
                      <h4 class="mb-3 fs-6 text-dark">Company</h4>
                      <ul class="m-0 list-unstyled">
                        <li class="mb-1">
                          <a href="#!" class="link-opacity-75 link-underline-opacity-0 link-opacity-100-hover link-underline-opacity-100-hover link-offset-1 link-dark">
                            About us
                  ...
                  <div class="col-12">
                    <div class="link-wrapper">
                      <ul class="m-0 list-unstyled d-flex justify-content-center justify-content-md-start gap-3">
                        <li>
                          <a href="#!" class="fs-7 link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-dark">
                      Terms
                    </a>
                  </li>
                  <li>
            ...
            <div class="border-top border-dark-subtle pt-3">
              <div class="row gy-3 align-items-center">
                <div class="col-12 col-md-6">
                  <div class="copyright-wrapper d-block mb-1 fs-8 text-dark text-center text-md-start">
