  ...
  return (
    <>
      <section class="py-3 py-md-5 py-xl-8">
        <div class="container">
          <div class="row bg-dark shadow-lg mb-4 p-4 rounded my-auto">
            <h4 class="fw-bold mb-2 text-white text-uppercase text-dark" style={{ fontSize: 'xx-larger' }}>Contact Information</h4>
          </div>
        </div>
              ...
              <div class="border rounded shadow-sm p-3">
                <form action="#!">
                  <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                    ...
                    {/* <!-- Message --> */}
                    <div class="col-12">
                      <label for="message" class="form-label"><b>Message</b><span class="text-danger">*</span></label>
                    ...
                    <div class="mb-4 mb-md-5">
                      ...
                      <div>
                        ...
                        <address class="m-0 text-secondary">
                          Plot.59,Reveune Housing Society,Rajendranagar,Kolhapur
                        </address>
                      </div>
                    </div>
                    {/* <!-- Phone & Email --> */}
                      ...
                      <div class="col-12 col-sm-6">
                        <div class="mb-4 mb-sm-0">
                          ...
                          <div>
                            ...
                            <hr class="mb-3 border-dark-subtle" />
                            <p class="mb-0">
                              <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">
                                livespace@gmail.com
                              </a>
                            </p>
                          </div>
